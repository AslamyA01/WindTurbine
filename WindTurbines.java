...
public class WindTurbine {
    ...
    public static void main(String[] args) {
        ...
        while (!input.equals("Q")) {
            ...
            System.out.println("3. Total Wind Turbines");
            System.out.println("4. Greatest Turbine Output");
            ...
            if (input.equals("1")) {
                ...
                System.out.println("This state with highest number of turbines is " + maxState(windData) );
...
//go through all but the first row (which is the headings)
    ...
    public static String maxState(ArrayList<String[]> windData) {
        String state = "";
        double sum = 0;
        double sum1 = 0;
